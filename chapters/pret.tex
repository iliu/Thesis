...
For memory operations that have longer latencies, thread-interleaved pipelines can hide the latency with its execution of other threads. 
...
In fact, most of the logic in a pipeline is dedicated to handling these pipeline hazards, so this also potentially shrinks the processor footprint\todo{need to find support}.
