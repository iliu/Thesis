...
Although less often mentioned, the presences of interrupts and exceptions in the pipeline are also a form of control hazards. 
Exceptions can occur during the execution of any instruction, which changes the control flow of the program to execute the exception handler.
