...
For example, IEEE 1588 \todo{citation} timestamps use 32 bits of nanoseconds and 48 bits of seconds to represent time.    
...
For distributed systems that require communication of timestamps across platforms, the consistent view of time across platforms must be obtained. \todo{cite ptides}
