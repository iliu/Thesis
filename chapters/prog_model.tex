...
Similar to \delayandset\ and \delayuntil, the \exceptiononexpire\ and \deactivateexception\ merely create a mechanism to specify desired timing constraints. 
...
\subsubsection{Controlling Different Timing Behaviors}
First we will show various methods of constructing different timing behaviors from a code block.
The code block could be task, a function, or any piece of code that could exhibit timing variability.    
We assume there is a desired execution time for this code block. 
The desired execution time could be from a specification of the application, or synthesized timing requirement from a higher level model.
This desired execution time   
